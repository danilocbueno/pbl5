...
\begin{tabular}{llll}
\toprule
\textbf{Tipo de falha} & \textbf{Modelo} & \textbf{Casos representativos} & \textbf{Natureza} \\
\midrule
Erro de sintaxe (não executa)         & deepseek-coder & P2\_vago, P3\_verboso        & Estrutural \\
Nome de função incorreto              & deepseek-coder & P2\_reformulado (\texttt{palindrome})  & Estrutural \\
Problema trocado                      & deepseek-coder & P4\_reformulado (gerou contador de consoantes) & Estrutural \\
Tipo de retorno incorreto             & qwen2.5-coder  & P5\_verboso (lista vs tupla) & Estrutural \\
Ordenação incorreta                   & qwen2.5-coder  & P5\_original (crescente vs decrescente) & Estrutural \\
Lógica incorreta com \texttt{set()}   & qwen2.5-coder  & P5\_vago (elimina duplicatas) & Estrutural \\
Normalização de maiúsculas ausente    & deepseek-coder & P2\_ingles/verboso (\texttt{s == s[::-1]}) & Estrutural \\
Erro de semântica de API              & qwen2.5-coder  & P4\_ingles (\texttt{str.count} com substring) & Estocástica \\
Normalização parcial                  & qwen2.5-coder  & P2\_com\_ruido (\texttt{s.lower()} sem \texttt{s[::-1].lower()}) & Estocástica \\
Caso base incorreto em recursão       & deepseek-coder & P3\_ingles (\texttt{return n} em vez de \texttt{return 1}) & Estrutural \\
Multiplicação de string (base retorna string) & deepseek-coder & P3\_reformulado run~4 (\texttt{n * "mensagem"} → 116~MB) & Estocástica \\
\bottomrule
\end{tabular}
\end{table}
...
Um achado particularmente notável emergiu na quarta run para o caso \texttt{deepseek-coder~|~P3\_reformulado}. O modelo gerou o seguinte código:
...
% =============================================================================
\section*{Apêndice — Ambiente de Execução e Tempo dos Experimentos}
% =============================================================================
